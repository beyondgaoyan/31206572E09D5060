...
$sort  = (isset($_REQUEST['sort'])  && in_array(trim(strtolower($_REQUEST['sort'])), array('goods_id', 'shop_price', 'last_update','goods_number'))) ? trim($_REQUEST['sort'])  : $default_sort_order_type;
