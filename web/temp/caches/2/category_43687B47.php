...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=19">产地</a> <code>&gt;</code> <a href="category.php?id=22">德国产品</a> </div>
</div>
<div class="blank"></div>
...
function deleteCartGoodsResponse(res)
{
 ...
 <div class="box_1">
  <div id="category_tree">
         <dl>
     <dt><a href="category.php?id=21">预售商品</a></dt>
            
       </dl>
         <dl>
     <dt><a href="category.php?id=22">德国产品</a></dt>
            
       </dl>
         <dl>
     <dt><a href="category.php?id=23">英国产品</a></dt>
            
       </dl>
         <dl>
     <dt><a href="category.php?id=24">美国产品</a></dt>
            
       </dl>
         <dl>
     <dt><a href="category.php?id=25">加拿大产品</a></dt>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
		 ...
		 <div class="box_1">
			<h3><span>商品筛选</span></h3>
			  ...
			  <strong>品牌：</strong>
														<span>全部</span>
																			<a href="category.php?id=22&amp;brand=1&amp;price_min=0&amp;price_max=0">德国喜宝HIPP</a>&nbsp;
																			<a href="category.php?id=22&amp;brand=2&amp;price_min=0&amp;price_max=0">德国汉高</a>&nbsp;
												</div>
											 </div>
		</div>
		<div class="blank5"></div>
 ...
 <div class="box_1">
  ...
  <a href="category.php?category=22&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/default/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=22&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/default/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=22&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/default/images/last_update_default.gif" alt="按更新时间排序"></a>
  ...
  <input type="hidden" name="order" value="DESC" />
    ...
    <div class="clearfix goodsBox" style="border:none;">
           ...
           <a href="javascript:;" id="compareLink" onClick="Compare.add(38,'德国HIPP喜...','0')" class="f6">比较</a>
                 ...
                 <div class="goodsItem">
           <a href="goods.php?id=37"><img src="images/201407/thumb_img/37_thumb_G_1404896579486.jpg" alt="Hipp喜宝有..." class="goodsimg" /></a><br />
           <p><a href="goods.php?id=37" title="Hipp喜宝有机小米免敏纯米粉 4个月 400克 2">Hipp喜宝有...</a></p>
                       市场价<font class="market_s">￥83元</font><br />
                                    本店价<font class="shop_s">￥69元</font><br />
                       <a href="javascript:collect(37);" class="f6">收藏</a> |
           <a href="javascript:addToCart(37)" class="f6">购买</a> |
           <a href="javascript:;" id="compareLink" onClick="Compare.add(37,'Hipp喜宝有...','0')" class="f6">比较</a>
        </div>
                 <div class="goodsItem">
           <a href="goods.php?id=36"><img src="images/201407/thumb_img/36_thumb_G_1404896516315.jpg" alt="HIPP喜宝有..." class="goodsimg" /></a><br />
           <p><a href="goods.php?id=36" title="HIPP喜宝有机大米米糊免敏米粉400g 4个月">HIPP喜宝有...</a></p>
                       市场价<font class="market_s">￥83元</font><br />
                                    本店价<font class="shop_s">￥69元</font><br />
                       <a href="javascript:collect(36);" class="f6">收藏</a> |
           <a href="javascript:addToCart(36)" class="f6">购买</a> |
           <a href="javascript:;" id="compareLink" onClick="Compare.add(36,'HIPP喜宝有...','0')" class="f6">比较</a>
        </div>
            </div>
    </div>
        </form>
...
<form name="selectPageForm" action="/category.php" method="get">
 <div id="pager" class="pagebar">
  <span class="f_l f6" style="margin-right:10px;">总计 <b>13</b>  个记录</span>
                      ...
                      <a href="category.php?id=22&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=goods_id&amp;order=DESC">[2]</a>
            
  <a class="next" href="category.php?id=22&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=goods_id&amp;order=DESC">下一页</a>    </div>
</form>
<script type="Text/Javascript" language="JavaScript">
<!--
function selectPage(sel)
...
>&nbsp;&nbsp;Licensed</a><br />
        <div align="left"  id="rss"><a href="feed.php?cat=22"><img src="themes/default/images/xml_rss2.gif" alt="rss" /></a></div>
 </div>
</div>
</body>
</html>
