      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            <td class="label">
            H.S.code </td>
            <td><input type="text" name="hscode" value="<?php echo $this->_var['goods']['hscode']; ?>" size="20"/></td>
          </tr>
          <tr>
            <td class="label">
            进口税则号 </td>
            <td><input type="text" name="tariffno" value="<?php echo $this->_var['goods']['tariffno']; ?>" size="20"/></td>
          </tr>
          <tr>
